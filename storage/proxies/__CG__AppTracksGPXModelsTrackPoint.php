 ...
 */
class TrackPoint extends \App\Tracks\GPX\Models\TrackPoint implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'latitude', 'longitude', 'elevation', 'id', 'createdAt', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrackPoint $proxy) {
